...
Tablea <- data.frame(Coluna = rep(c("Price", "Carat", "Cut", "Color", "Clarity", "x", "y", "z", "Depth", "Table")),
...
A Figura \@ref(fig:pressure) ilustra bem o que representam os dados Quantitativos Contínuos dimensionais do diamante. O preço dispensa explicações, e Carat é a principal medida de qualidade, e indica o peso da pedra. As formulas de Table e Depth também podem ser observadas na imagem. 

```{r pressure, echo=FALSE, fig.cap="Dimensões do Diamente", out.width = '100%', fig.pos="H"}
...
```{r dadoslong, echo=FALSE, fig.cap="Dimensões do Diamente", out.width = '100%'}
...
```{r mediasdvar,fig.cap='Histograma Preço', echo=F,   fig.pos="H"}
...
```{r outliers,fig.cap='Histograma Preço', echo=F,   fig.pos="H"}
